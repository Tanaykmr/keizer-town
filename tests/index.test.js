...
const axiosHandler = async (method, ...args) => {
	try {
...
const axios = {
	post: (...args) => axiosHandler("post", ...args),
	get: (...args) => axiosHandler("get", ...args),
	put: (...args) => axiosHandler("put", ...args),
	delete: (...args) => axiosHandler("delete", ...args),
};
